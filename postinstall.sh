...
<html>
  ...
  <body>
    ...
    <script src="bitcoin-plugin.js"></script>
...
cp ./node_modules/edge-core-js/lib/react-native/edge-core.js.map ./ios/edge-core
cp ./node_modules/edge-currency-accountbased/lib/react-native/edge-currency-accountbased.js ./ios/edge-core
cp ./node_modules/edge-currency-accountbased/lib/react-native/edge-currency-accountbased.js.map ./ios/edge-core
cp ./node_modules/edge-currency-bitcoin/lib/react-native/bitcoin-plugin.js ./ios/edge-core
cp ./node_modules/edge-currency-bitcoin/lib/react-native/bitcoin-plugin.js.map ./ios/edge-core
cp ./node_modules/edge-currency-monero/lib/react-native/edge-currency-monero.js ./ios/edge-core
cp ./node_modules/edge-currency-monero/lib/react-native/edge-currency-monero.js.map ./ios/edge-core
cp ./node_modules/edge-exchange-plugins/lib/react-native/edge-exchange-plugins.js ./ios/edge-core
cp ./node_modules/edge-exchange-plugins/lib/react-native/edge-exchange-plugins.js.map ./ios/edge-core
